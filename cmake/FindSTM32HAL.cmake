IF(STM32_FAMILY STREQUAL "F0")
  ...
  SET(HAL_EX_COMPONENTS adc crc dac flash i2c pcd pwr
...
ELSEIF(STM32_FAMILY STREQUAL "F7")
  SET(HAL_COMPONENTS adc can cec cortex crc cryp dac dcmi dfsdm dma dma2d
      dsi eth flash gpio hash hcd i2c i2s irda iwdg lptim ltdc nand nor pcd
...
ELSEIF(STM32_FAMILY STREQUAL "L0")
  SET(HAL_COMPONENTS adc comp cortex crc crs cryp dac dma exti firewall
      flash gpio i2c i2s irda iwdg lcd lptim lpuart pcd pwr rcc rng rtc
      smartcard smbus spi tim tsc uart usart utils wwdg)

  SET(HAL_REQUIRED_COMPONENTS cortex pwr rcc)

  # Components that have _ex sources
  SET(HAL_EX_COMPONENTS adc comp crc cryp dac flash i2c pcd pwr rcc rtc
      smartcard tim uart usart)
